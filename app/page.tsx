        ...
        <div className="image flex flex-col items-center justify-center mt-15">
          ...
          >
            {<div className="info flex flex-col justify-center items-center mt-3 text-center">
              ...
              <span className="md:text-4xl text-2xl font-bold text-gray-300 flex flex-col md:gap-13 gap-8">I am a Full Stack Engineer contributing in many Large-scale Applications.
                <span className="text-lg font-normal">With expertise in MERN Stack, .NET, Reactjs, NEXTjs and Blockchain, I focus on delivering scalable and efficient products.</span>
              </span>
            </div>}
          </motion.div>
        </div>
